  ...
  return (
    <>
      ...
      <Modal
        ...
        okText={<div className="font-medium">Ứng tuyển</div>}
        cancelText="Đóng"
        className="full-screen"
        width="100%"
      >
        <div className="flex gap-2 items-center mb-2 p-2 sticky top-0 bg-[white] shadow z-10">
          <div className="flex avatar w-8 min-w-8">
            <img src={comp?.logo} className="object-cover" />
          </div>
          <div className="flex font-medium text-[15px]">{comp?.name}</div>
        </div>
        <div className="-my-2 p-4">
          <div className="flex flex-col text-[13px]">
            <div className="flex w-full list_img">
              {tin?.images_details?.map((img) => (
                <div
                  key={img.uid}
                  className={`max-h-40 h-40 item overflow-hidden w-full object-cover 
            ...
            <div className="flex justify-between">
              <b className="font-medium text-[16px] mt-2">{tin?.title}</b>
            </div>
            ...
            <div className="flex justify-end gap-1 mb-2">
              <Tooltip
                title={<div className="text-[#293b50]">Lượt thích</div>}
                color="white"
              >
                <div
                  className="flex rounded border text-[11px] font-medium
                 border-[#eee] items-center px-1.5 py-0.5 gap-1 text-[#546485]"
                >
                  <IoMdHeart size={13} className="text-[#999]" />{" "}
                  {tin?.likes?.length}
                </div>
              </Tooltip>
              <Tooltip
                title={<div className="text-[#293b50]">Hồ sơ đã nộp</div>}
                color="white"
              >
                <div
                  className="flex rounded border text-[11px] font-medium
              ...
              <Tooltip
                title={<div className="text-[#293b50]">Lượt xem</div>}
                color="white"
              >
                <div
                  className="flex rounded border text-[11px] font-medium
                 border-[#eee] items-center px-1.5 py-0.5 gap-1 text-[#546485]"
                >
                  <FaEye size={12} className="text-[#999]" /> {tin?.view_count}
                </div>
              </Tooltip>
              <Tooltip
                title={<div className="text-[#293b50]">Lượt share</div>}
                color="white"
              >
                <ShareModal
                ...
                >
                  <div
                    className="flex rounded border text-[11px] font-medium
                 border-[#eee] items-center px-1.5 py-1 gap-1 text-[#546485]"
                  >
                    <FaShare size={12} className="text-[#999]" /> Chia sẻ
                    <div className="flex bg-[#b5bac4] text-[white] px-1 justify-center rounded">
                      {tin?.share_count}
                    </div>
                  </div>
                </ShareModal>
              ...
              >
                <div className="flex my-1 border shadow rounded-md border-[#0001] p-2">
                  <div className="flex flex-col">
                    <div className="flex font-medium text-[18px] text-[#f30]">
                      +{tin?.thuong_sotien?.toLocaleString()}VNĐ/người
                    </div>
                  ...
                  <div
                    className="flex bg-[#f30] ml-auto px-2 h-12 items-center justify-center 
                    text-[white] rounded relative flex-col"
                  >
                    <BiSolidGift className="animate-bounce leading-0 -mb-2 text-[20px] z-1 relative mt-auto" />
                    <div className="flex w-4 absolute h-1 bg-[#0002] bottom-4 rounded-[99%]"></div>
                    <div className="text-[9px] mt-auto mb-0.5">Nhận ngay</div>
                  </div>
                </div>
              </ShareModal>
            )}
            ...
            <div className="flex flex-col text-[12px] mt-1">
              ...
              {tin?.thuong && (
                <>
                  ...
                  <div className="flex font-medium items-center gap-1 text-[#1a346d]">
                    <HiBellAlert />
                    Điều kiện thưởng:
                  </div>
          ...
          <div className="overflow-hidden text-[12px] mt-1">
            <div className="flex font-medium">Mô tả công việc:</div>
            <div className="flex bg-[#eee] p-2 rounded mt-1">
              {tin?.noidungbosung || ""}
            </div>
          </div>
          <div className="border mt-2 border-[#073264] rounded-md overflow-hidden text-[12px]">
            <div className="flex bg-[#073264] text-white font-medium p-2">
              Thông tin ứng tuyển
            </div>
            <div className="flex flex-col p-2">
              <div className="mb-1 flex justify-between items-center">
                <label className="block text-gray-700 w-40 font-medium">
              ...
              <div className="mb-1 flex justify-between items-center">
                ...
                <input
                  ...
                  disabled={
                    (invent_code || "")?.length > 0 &&
                    invent_code === ttungtuyen.invent_code
                  }
                  type="text"
